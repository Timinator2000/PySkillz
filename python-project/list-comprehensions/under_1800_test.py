...
exec(f'from {section}{exercise_name} import {exercise_name} as user_solution')
exec(f'from {section}{exercise_name}_solution import {exercise_name} as suggested_solution')
